...
import HardenedMarkdown from "@/components/HardenedMarkdown";
  ...
  return (
    <div className="font-sans min-h-screen p-8 pb-20 sm:p-20">
      <main className="max-w-6xl mx-auto">
          ...
          {markdownExamples.map((example, index) => (
            ...
            >
              ...
              <div className="prose dark:prose-invert max-w-none">
                {useHardened ? (
                  <HardenedMarkdown
                    allowedLinkPrefixes={['https://github.com/', 'https://docs.', 'https://www.']}
                    allowedImagePrefixes={['https://via.placeholder.com/', 'https://images.unsplash.com/', '/']}
                  >
                    {example.content}
                  </HardenedMarkdown>
                ) : (
        ...
        {useHardened && (
          <div className="mt-12">
            <h2 className="text-2xl font-bold mb-6 text-center">Security Examples</h2>
        ...
        {useHardened && (
          <div className="mt-12 p-6 bg-blue-50 dark:bg-blue-950 rounded-lg">
            <h3 className="text-xl font-bold mb-3">HardenedMarkdown Configuration</h3>
            <div className="space-y-2 text-sm">
              <p><strong>Allowed Link Prefixes:</strong></p>
              <ul className="list-disc list-inside ml-4">
                <li><code>https://github.com/</code></li>
                <li><code>https://docs.</code></li>
                <li><code>https://www.</code></li>
              </ul>
              <p className="mt-3"><strong>Allowed Image Prefixes:</strong></p>
              <ul className="list-disc list-inside ml-4">
                <li><code>https://via.placeholder.com/</code></li>
                <li><code>https://images.unsplash.com/</code></li>
                <li><code>/</code> (local images)</li>
              </ul>
            </div>
          </div>
        )}
        ...
        <div className="mt-12 p-6 bg-gray-100 dark:bg-gray-800 rounded-lg">
          ...
          <p className="mb-4">Here's a live example with all features combined:</p>
